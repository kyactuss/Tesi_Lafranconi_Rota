...
def generate_random_parameters(scenario_idx, map_size=None):
    ...
    # 1. Close centers (Distance <= 5 from target)
    close_centers = [pos for pos in free_coords if max(abs(pos[0] - target_pos[0]), abs(pos[1] - target_pos[1])) <= 5]
